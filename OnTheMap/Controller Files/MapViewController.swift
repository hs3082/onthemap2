...
class MapViewController: UIViewController {
    ...
    @IBAction func refreshMap(_ sender: Any) {
        pullData()
        /// ////////////////////////////////////////////  Troubleshooting Map refresh buttong  ////////////////////////////////////////////
        print("Refresh Map buttong pressed")
    }
    

    @IBAction func addPinPressed(_ sender: Any) {
        print("add pin buttong pressed")
        ...
        UdacityClient.getStudentLocation(singleStudent: false, completion:{ (data, error) in
            ...
            alertVC.addAction(UIAlertAction(title: "Yes", style: .default, handler: { [unowned self] (_) in
                self.performSegue(withIdentifier: "addPin",  sender: (true, data))
            }))
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "addPin" {
            let destinationVC = segue.destination as? FindPinViewController
